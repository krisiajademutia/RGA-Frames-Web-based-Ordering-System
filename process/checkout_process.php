...
if ($isBuyNow) {
    ...
    $total_price     = $prices['grand_total'] + $delivery_fee;
    ...
    // Handle GCash receipt if needed
    $paymentProof = null;
    ...
    // Place order directly via CustomFrameService buyNow
    ...
    if ($result['success']) {
        // If GCash, also insert payment proof
