...
<body class="reg-body-reset">
    ...
    <div class="container-fluid p-0">
        <div class="row g-0 min-vh-100">
            ...
            <div class="col-lg-6 d-flex flex-column p-4 p-md-5 reg-form-col">

                <!-- Welcome section (title + subtitle shown above form on mobile) -->
                <div class="reg-welcome-section">
                    ...
                    <form id="regForm" action="process/register_process.php" method="POST" novalidate>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <?php if (isset($errors['first_name'])): ?>
                                    <div class="text-danger small mt-1"><?php echo htmlspecialchars($errors['first_name']); ?></div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <?php if (isset($errors['last_name'])): ?>
                                    <div class="text-danger small mt-1"><?php echo htmlspecialchars($errors['last_name']); ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <?php if (isset($errors['username'])): ?>
                                <div class="text-danger small mt-1"><?php echo htmlspecialchars($errors['username']); ?></div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <?php if (isset($errors['phone_number'])): ?>
                                <div class="text-danger small mt-1"><?php echo htmlspecialchars($errors['phone_number']); ?></div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mb-4 form-check">
                            ...
                            <?php if (isset($errors['data_privacy'])): ?>
                                <div class="text-danger small mt-1"><?php echo htmlspecialchars($errors['data_privacy']); ?></div>
                            <?php endif; ?>
                        </div>
            ...
            <div class="col-lg-6 d-none d-lg-block reg-image-side"></div>
