...
<style>
    ...
    .navbar {
        ...
        z-index: 2000 !important; /* Forces header to stay above all other content */
    }
...
<nav class="navbar navbar-expand-lg fixed-top">
    <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCustomer" aria-controls="navbarCustomer" aria-expanded="false">
