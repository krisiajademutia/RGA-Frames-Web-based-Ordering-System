...
<header class="admin-header">
    ...
    <div class="nav-pills">
        <a href="/RGA-Frames-Web-based-Ordering-System-main/admin/admin_dashboard.php" class="nav-btn">
            <i class="fas fa-tachometer-alt"></i> Dashboard
        </a>
        <a href="/RGA-Frames-Web-based-Ordering-System-main/admin/admin_orders.php" class="nav-btn">
            <i class="fas fa-clipboard-list"></i> Orders
        </a>
        <a href="/RGA-Frames-Web-based-Ordering-System-main/admin/admin_post_frames.php" class="nav-btn">
            <i class="fas fa-plus"></i> Post Frames
        </a>
        <a href="/RGA-Frames-Web-based-Ordering-System-main/admin/admin_custom_frame_options.php" class="nav-btn">
